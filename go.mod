...
replace github.com/danielm-codefresh/argo-multi-cluster v0.0.0-20220327145759-1c387c8ebc5f => github.com/daniel-codefresh/argo-multi-cluster v0.0.0-20220628093809-3834485941a6
