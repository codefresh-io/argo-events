...
func NewEventSourceAdaptor(eventSource *aev1.EventSource, eventBusConfig *aev1.BusConfig, eventBusSubject, hostname string, metrics *eventsourcemetrics.Metrics, cfClient *codefresh.Client) *EventSourceAdaptor {
