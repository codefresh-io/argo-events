...
func NewSensorContext(kubeClient kubernetes.Interface, dynamicClient dynamic.Interface, sensor *v1alpha1.Sensor, eventBusConfig *v1alpha1.BusConfig, eventBusSubject, hostname string, metrics *sensormetrics.Metrics, cfClient *codefresh.Client) *SensorContext {
